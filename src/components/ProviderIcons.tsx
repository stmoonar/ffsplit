...
function KimiIcon({ size = 20, className }: { size?: number | string; className?: string }) {
...
// Ollama brand logo — llama face
function OllamaIcon({ size = 20, className }: { size?: number | string; className?: string }) {
    const s = typeof size === "string" ? size : `${size}px`;
    return (
        <svg
            className={className}
